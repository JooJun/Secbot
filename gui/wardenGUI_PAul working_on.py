...
config = {}
config_handle = open(config_file_path)
...
class App:
	def __init__(self,master,res):			
		...
		self.master.iconbitmap('resources/warden.ico')			
		...
		self.vid_dis_img_path = 'resources/vid_disconnect.jpg'
		...
		self.img_path = 'resources/cluedo.jpg'	
		...
		self.conn_dict = {}
		self.conn_dict['video_conn_ready'] = False
		#self.video_conn_ready = False
		self.conn_dict['pi_conn_ready'] = False
		#self.pi_conn_ready = False
		self.conn_dict['video_ready'] = False
		#self.video_ready = False	
		self.conn_dict['ssh_ready'] = False
	...
	def return_conn_status(self,conn):
		return self.conn_dict[conn]		
